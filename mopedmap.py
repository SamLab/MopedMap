...
REGION_ALIASES = [
    ...
    # каменка в Брянской области (не путать с Каменка Пензенской)
    {"pattern": "каменка", "name": "Каменка", "lat": 52.00, "lon": 34.38, "type": "city", "is_region": False},
...
<script>
const map = L.map('map', {{ center: [55.7558, 37.6173], zoom: 7, zoomControl: true, attributionControl: false }});
